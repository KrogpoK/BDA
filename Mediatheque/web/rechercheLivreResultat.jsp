<%-- 
    Document   : rechercheLivreResultat
    Created on : 11 nov. 2012, 10:14:19
    Author     : jeremiefabre
--%>
...
<h3>Resultats : ${requestScope.listLivres.size()}</h3>
<div class="container-fluid well">
    <table class="table table-hover">
        ...
        <tbody>
            <% int cpt = 0;%>
            <c:forEach var="oeuvre" begin="0" items="${requestScope.listLivres}">
                <tr>
