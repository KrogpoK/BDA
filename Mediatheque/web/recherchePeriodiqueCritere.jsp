<%-- 
    Document   : recherchePeriodiqueCritere
    Created on : 11 nov. 2012, 10:15:45
    Author     : jeremiefabre
--%>
...
<h1>Recherche des Périodiques</h1>
<form id="searchFilmForm" action="RechercheOeuvre" method="post">
    <table>
        <tr>
            ...
            <td><input type="radio" id="periodique" name="typeSupport" value="Periodique" checked="true" /></td><td>Periodique</td>
        </tr>
        <tr>
            Titre : 
        ...
        Thème : 
        <input type="text" id="themeSearch" name="themeSearch" placeholder="theme" />
        Périodicité : 
        <select name="periodiciteSearch">
            <option selected="true"></option>
